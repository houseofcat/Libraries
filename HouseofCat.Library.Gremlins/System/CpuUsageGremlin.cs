...
using HouseofCat.Models.Gremlins;
using System;
using System.Linq;
using System.Threading;
using System.Threading.Tasks;
using static HouseofCat.Models.Enums;
using static HouseofCat.Library.Utilities.HardwareHelpers;

namespace HouseofCat.Library.Gremlins
{
    /// <summary>
    ...
    public class CpuUsageGremlin : IDisposable
    {
        ...
        public CpuUsageGremlin()
        {
            ...
            {
                CoreCount = GetCpuCount(),
                CpuCount = GetCpuCount(),
                LogicalProcessorCount = GetTotalLogicalProcessorCount()
            };
        }
